...
VL_ATTR_COLD void Vmux21___024root__trace_init_sub__TOP__0(Vmux21___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+3,"s",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBit(c+4,"y",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
...
VL_ATTR_COLD void Vmux21___024root__trace_init_top(Vmux21___024root* vlSelf, VerilatedFst* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_ATTR_COLD void Vmux21___024root__trace_full_top_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vmux21___024root__trace_chg_top_0(void* voidSelf, VerilatedFst::Buffer* bufp);
void Vmux21___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/);

VL_ATTR_COLD void Vmux21___024root__trace_register(Vmux21___024root* vlSelf, VerilatedFst* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    Vmux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_ATTR_COLD void Vmux21___024root__trace_full_sub_0(Vmux21___024root* vlSelf, VerilatedFst::Buffer* bufp);
