...
void Vmux21___024root__trace_init_top(Vmux21___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vmux21::trace(VerilatedFstC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vmux21::trace()' shall not be called after 'VerilatedFstC::open()'.");
    }
