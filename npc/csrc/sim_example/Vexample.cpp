...
void Vexample___024root__trace_init_top(Vexample___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vexample::trace(VerilatedFstC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vexample::trace()' shall not be called after 'VerilatedFstC::open()'.");
    }
