...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 167 of file://<WORKSPACE>/npc/ssrc/cpu/idu/decoder.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
   ...
   164                 case InstType. C => CSRAddrSel.Ins.id
   165                 case _           => CSRAddrSel.  N.id
   166             }
   167             val is_ecall = toInt(_CURSOR_inst_type == InstType.EC)
   168             // val rs1Sel = toInt(inst_type == InstType.CI)
   169             // val rs2Sel = toInt(inst_type == InstType.CR || inst_type == InstType.CI)
   170             
