...
### scala.reflect.internal.FatalError: 
  ThisType(method decode) for sym which is not a class
  ...
  last tree to typer: TypeTree
       tree position: line 116 of file://<WORKSPACE>/npc/ssrc/cpu/idu/decoder.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
   ...
   113                 case InstType.C  => GPRWSel.CSR.id
   114                 case _           => GPRWSel.EXU.id
   115             }
   116             val reg_wen = toInt(
   117                 (_CURSOR_inst)
   118             )
   119             val is_invalid = toInt(inst_type == InstType.IVD)
