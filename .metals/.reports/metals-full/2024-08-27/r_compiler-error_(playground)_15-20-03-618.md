file://<WORKSPACE>/npc/ssrc/cpu/idu/decoder.scala
...
== Source file context for tree position ==
   ...
   156                 case InstType. C => CSRAddrSel.Ins.id
   157                 case _           => CSRAddrSel.  N.id
   158             }
   159             val csr_raddr_sel = _CURSOR_inst_type match {
   160                 case InstType.EC => CSRAddrSel.VEC.id
   161                 case InstType.MR => CSRAddrSel.EPC.id
   162                 // case InstType.CR => CSRAddrSel.Ins.id
